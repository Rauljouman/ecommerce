...
app.post("/send-email", async (req, res) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: "rauljouman.ip@gmail.com", // La teva adreça de Gmail
    pass: "btng dhxr wwpd xngb", // Contrasenya d'Aplicació de Gmail
    },
  });

  const mailOptions = {
    from: email,
    to: "rauljouman.ip@gmail.com", // Correu on vols rebre els missatges
